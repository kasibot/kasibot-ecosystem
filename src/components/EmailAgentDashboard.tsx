...
import { LiveEmailActivity } from "@/components/LiveEmailActivity";
import KpiCard from "@/components/KpiCard";
import { EmailBusinessImpact } from "@/components/EmailBusinessImpact";
        ...
        <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <KpiCard
                icon={CheckCircle}
                title="Auto-Handled Percentage"
                value={`${kpiData.autoHandledPercentage}%`}
                trend={{ value: 8, isPositive: true }}
              />
              <KpiCard
                icon={Target}
                title="Human-Required Emails"
              ...
              <KpiCard
                ...
                value={`${kpiData.avgResponseTime} mins`}
                trend={{ value: 3, isPositive: false }}
              />
              <KpiCard
                icon={TrendingUp}
                title="Emails Categorized Correctly"
